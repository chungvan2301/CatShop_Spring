(function ($, undefined) {
  ...
  Rating.prototype = {
    _init: function () {
      ...
      for (var i = 1; i <= this._rateToIndex(this.options.stop); i++) {
        ...
        $('<div style="color:#D5D5B8" class="rating-symbol-background ' + this.options.empty + '"></div>')
          .appendTo($symbol);
        // Add foreground symbol to the symbol container.
        // The filled icon is wrapped with a div to allow fractional selection.
        $('<div class="rating-symbol-foreground"></div>')
          .append('<span style="color:#E0E708;" class="' + this.options.filled + '"></span>')
          .css({
            display: 'inline-block',
            position: 'absolute',
            overflow: 'hidden',
  ...
  // Plugin defaults.
  $.fn.rating.defaults = {
    filled: 'fa fa-star fa-xl',
    filledSelected: undefined,
    empty: 'fa fa-star fa-xl',
    start: 0,
    stop: OFFSET,
    step: 1,
    fractions: 1,
